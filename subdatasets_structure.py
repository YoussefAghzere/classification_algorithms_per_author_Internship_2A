...
for dir in authors_dirs:
    ...
    os.makedirs(f"{dir}/{basename}_Human")
    os.makedirs(f"{dir}/{basename}_AI")
"""
...
for f in authors_folders:
        ...
        for file in txt_files:
            shutil.copy(file, f"/home/youssef/Desktop/classification_algorithms_per_author/Datasets_per_author/{basename}/{basename}_AI/{file.split('/')[-1]}")
